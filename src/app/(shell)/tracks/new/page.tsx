    ...
    <div className="flex flex-1 flex-col bg-splice-surface px-4 py-12 dark:bg-splice-navy">
      <main className="mx-auto w-full max-w-2xl rounded-xl border border-splice-sky bg-white p-8 shadow-sm dark:border-splice-navy-light dark:bg-splice-navy">
        ...
        <section className="mt-8">
          <h2 className="text-sm font-semibold uppercase tracking-wide text-splice-ocean">Upload file</h2>
        ...
        <section className="mt-10 border-t border-splice-sky pt-8 dark:border-splice-ocean">
          <h2 className="text-sm font-semibold uppercase tracking-wide text-splice-ocean">Strava</h2>
          {strava ? (
            ...
            <p className="mt-3 text-sm text-splice-ocean dark:text-splice-water">
              <Link href="/api/strava/authorize" className="underline">
                Link Strava
              </Link>{" "}
